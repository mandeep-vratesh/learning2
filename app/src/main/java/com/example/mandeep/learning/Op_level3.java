...
public class Op_level3 extends Activity{
    String[] string_input = {"1", "*", "2", "+", "(", "2", "+", "3",")"};
    ...
    protected void onStart() {
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent go_to_next_stage = new Intent(Op_level3.this,Op_level2.class);
        ...
        again.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent go_to_next_stage = new Intent(Op_level3.this,Op_level3.class);
                startActivity(go_to_next_stage);
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent go_to_practice = new Intent(Op_level3.this,Operator_practice.class);
